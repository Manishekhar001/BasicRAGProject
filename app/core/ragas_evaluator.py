"""RAGAS evaluation module for quality assessment"""
...
class RAGASEvaluator:
    ...
    def __init__(self):
        ...
        eval_embedding_model = (
            self.settings.ragas_embedding_model
            if self.settings.ragas_embedding_model is not None
    ...
    async def aevaluate(
        ...
        try:
            ...
            # Run evaluation in thread pool; enforce the configured timeout
            result = await asyncio.wait_for(
                asyncio.to_thread(self._evaluate_with_timeout, dataset),
