...
class RAGChain:
    ...
    def query_with_sources(self, question : str) -> dict:
        ...
        try:
            ...
            source_docs = self.retriever.invoke(question)  # sync – correct here
    ...
    async def aquery_with_sources(self, question: str) -> dict:
        ...
        try:
            ...
            # Get source documents asynchronously
            ...
            contexts = [source.page_content for source in source_docs]
    ...
    async def aquery_with_evaluation(self, question:str, include_sources : bool = True) -> dict:      
        ...
        logger.info(f"Processing async query with evaluation: {question[:100]}...")
